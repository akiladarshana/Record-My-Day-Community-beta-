...
/*
 * This class handles all cryptography based operations in the system 
 * Encryption is based on 128bit AES scheme 
 * 
...
public class Crypto {
	...
	/*
	 * Encrypts a String using provided key
	 * 
	 * @param key
	 * 
	...
	/*
	 * decrypts a String using provided key
	 * 
	 * @param key
	 * 
	...
	/*
	 * Encrypts a byte stream using provided key
	 * 
	 * @param key
	 * 
	 ...
	 * @throws exception if encryption fails
	 */
	public static byte[] encrypt(String seed, byte[] cleartext)
			throws Exception {
		byte[] rawKey = getRawKey(seed.getBytes());
	...
	/*
	 * decrypts a byte stream using provided key
	 * 
	 * @param key
	 * 
